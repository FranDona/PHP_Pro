...
//Visualiza los datos sin ordenar
...
//Visualizar datos si se ordenan-------------------------------------
if (isset($_POST['ordenPrecio'])) {
    $orden = isset($_SESSION['ordenPrecio']) && $_SESSION['ordenPrecio'] == 'ASC' ? 'DESC' : 'ASC';
    $_SESSION['ordenPrecio'] = $orden;
        ...
        <br>
            ...
            <h2 hidden>Zona de consultas</h2>
                ...
                <h2 hidden>Consultas</h2>
                    <a class="btn btn-primary" href="clientes.php">Ver coches disponibles</a>
                    ...
                    <form method="post" class="btn-group">
                        <button type="submit" class="btn btn-success " name="ordenPrecio">Ordenar por precio</button>
                    </form>
                </article>
